      ...
      <svg xmlns='http://www.w3.org/2000/svg' width='400' height='600'>
        <defs>
          <linearGradient id="Gradient" x1="0" x2="0" y1="0" y2="1"
            ...
            <stop offset="50%" stop-color="#321c3e" />
            <stop offset="100%" stop-color="#060a1f" />
          </linearGradient>
        </defs>
        <rect x="10" y="10" width="400" height="600"
          fill="url(#Gradient)"/>
        <text x="35" y="85" font-family="Verdana" font-size="65">🌙</text>
        <text x="53" y="180" font-weight="bold" font-family="Verdana" font-size="12" fill="rgb(255, 255, 255, .5)">m3mento presents</text>
        <text x="70" y="265" font-family="Verdana" font-size="50" fill="rgb(250, 204, 21)">NIGHTS &amp;</text>
        <text x="60" y="310" font-family="Verdana" font-size="50" fill="rgb(250, 204, 21)">WEEKENDS</text>
        <text x="128" y="342" font-family="Verdana" font-size="23" fill="rgba(250, 204, 21, .9)" font-weight="bold">DEMO DAY</text>
        <text x="45" y="410" font-family="Verdana" font-size="16" font-weight="bold" fill="white">WHEN: </text>
        <text x="112" y="410" font-family="Verdana" font-size="16" fill="white">August 6th, 2022 </text>
        <text x="45" y="440" font-family="Verdana" font-size="16" font-weight="bold" fill="white">TIME:</text>
        <text x="102" y="440" font-family="Verdana" font-size="16" fill="white">3:00pm UTC </text>
        <text x="45" y="570" font-family="Verdana" font-size="130">🦄</text>
        <text x="220" y="550" font-family="Verdana" font-size="65" fill='#ffeffa' font-weight='bold'>001</text>
        <svg x="275" y="30" xmlns="http://www.w3.org/2000/svg" height="100" width="100" viewBox="0 0 29 29" rednerAs="svg">
