  ...
  return (
    <div className="mt-5 self-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="400" height="600">
        ...
        <rect x="10" y="10" width="400" height="600" fill="url(#Gradient)" />
        <text x="35" y="85" fontFamily="Verdana" fontSize="65">
          🌙
        </text>
        <text
          x="53"
        ...
        <text x="112" y="410" fontFamily="Verdana" fontSize="16" fill="white">
          August 6th, 2022{" "}
        </text>
        <text
          x="45"
        ...
        <text x="102" y="440" fontFamily="Verdana" fontSize="16" fill="white">
          3:00pm UTC{" "}
        </text>
        <text x="45" y="570" fontFamily="Verdana" fontSize="130">
          🦄
        </text>
        <text
          x="220"
